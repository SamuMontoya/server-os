...
- Formato de salida: NUNCA diagramas ASCII ni cajas dibujadas con caracteres especiales para tablas o flujos/jerarquías. Para tablas, SIEMPRE markdown estándar (\`| columna | columna |\` con la fila de guiones debajo). Para flujos, usa listas anidadas o párrafos — nunca arte ASCII. El motivo (pedido explícito y repetido de ${OWNER}): necesita copiar y pegar el contenido directo a Notion/Keynote/Docs, y el arte ASCII se rompe al pegarlo.
